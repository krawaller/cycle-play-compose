...
export type AssignableInputSources = { DOM: MainDOMSource, state: StateSource<AssignableInputState> };
export type AssignableInputSinks = { DOM: Stream<VNode>, state: Stream<Reducer<AssignableInputState>>  };

export default function AssignableInput(sources: AssignableInputSources): AssignableInputSinks {
